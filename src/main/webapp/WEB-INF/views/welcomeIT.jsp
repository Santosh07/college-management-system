...
<body>
	...
	<div class="container"> 
		<form action="<c:url value="/department/addCourse" />" method="get">
	    	<button class="btn btn-primary btn-lg btn-block" name = "addCourse">Add Course</button>
		</form>
		<br />
		<form action="<c:url value="/department/seeCourseInfo" /> " method="get">
	    	<button class="btn btn-primary btn-lg btn-block" name = "addCourse">See Course Info</button>
		</form>
		<br />
	
		<form action="<c:url value="/department/seeInstructorsByDepartment"/> " method="get">
