...
<body>
	...
	<div class="row text-info">
		<div class="col-md-6">
		<h3>Date : ${attendance.getAttendanceId().getYear()}/${attendance.getAttendanceId().getMonth()}/${attendance.getAttendanceId().getDate()}<br/><br/>
	...
	<table class="table table-bordered">
		...
		<form:form action="${url1 }" modelAttribute="tempAttendance" enctype="form-data">
