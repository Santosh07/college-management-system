...
<body>
	<div class="jumbotron">
		<div class="container">
			...
			<div style="padding-top: 20px">
				<a class="btn btn-danger" href="<c:url value="/department/${name}" />">Back</a>
			</div>
		</div>
	</div>
	...
	<table class="table table-bordered">
		...
		<tr class="info">
			...
			<td><a href="<c:url value="/department/updateCourse?courseId=${course.getCourseId()}" /> "> Update </a></td>
			<td><a href="<c:url value="/department/deleteCourse?courseId=${course.getCourseId()}" /> "> Delete </a></td>			
		</tr>
		</c:forEach>
