...
charset=ISO-8859-1">
<link rel="stylesheet" type="text/css" href="http://${pageContext.request.localName}:${pageContext.request.localPort}/college/resource/css/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="http://${pageContext.request.localName}:${pageContext.request.localPort}/college/resource/css/myCSS.css">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<form action="<c:url value="/faculty" />" method="get">
					<button class="btn btn-primary btn-lg btn-block">Facutly</button>
				</form>
			</div>
